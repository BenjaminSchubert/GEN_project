...
"""
This is a quick port from twisted.internet._threadedselect to python3.

Parts that were changed are shown by `python3 compat` as a comment just before

This is largely untested work, use at your own risks

If you need this reactor, before anything else in your program do :

    | import phagocyte_fronted.twisted_reactor
    | import twisted.internet
    | twisted.internet._threadedselect = phagocyte_frontend.twisted_reactor

And then follow the module's documentation that follows

patch author: "Benjamin Schubert <ben.c.schubert@gmail.com>"
"""
